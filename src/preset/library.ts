...
function seedPresets(): Preset[] {
   ...
   * electric-garden.mp3 backs five of them. A per-card mode from
  ...
  /**
   * Mastering rewrote these files in place under their existing names — renaming
   * them would break the license manifest that gates the build — so a version
  ...
  const curatedMusic = (
    ...
    assetId,
    url: `/audio/curated/${file}?v=${CURATED_ASSET_VERSION}`,
    name,
    mimeType: 'audio/mpeg',
    durationSeconds: playback.targetDurationSeconds,
    playback,
    provenance: { provider: 'elevenlabs', model: 'music_v2', vocalMode: 'instrumental', createdAt },
  });
  const curated = (assetId: string, file: string, name: string, createdAt: string): MusicAsset =>
    curatedMusic(assetId, file, name, CURATED_PLAYBACK[file], createdAt);
  const marketScores: Record<string, MusicAsset> = {
    'market-pixel-last-broadcast': curated('builtin_last_broadcast_score', 'last-broadcast.mp3', 'Moonlit signal', '2026-08-13T22:18:47.735Z'),
    'market-pixel-midnight-shrine': curated('builtin_pixel_forest_score', 'pixel-forest.mp3', 'Pixel forest nocturne', '2026-08-15T12:08:00.000Z'),
    'market-pixel-lantern-save': curated('builtin_japanese_water_garden', 'japanese-water-garden.mp3', 'Japanese water garden', '2026-08-11T20:27:00.000Z'),
    'market-cozy-gatehouse-rest': curated('builtin_gatehouse_rain', 'gatehouse-rain.mp3', 'Gatehouse rain', '2026-08-15T00:51:00.000Z'),
    'market-living-ember-throne': curated('builtin_ember_throne_score', 'foggy-stone-shelter.mp3', 'Ember throne vigil', '2026-08-15T00:53:00.000Z'),
    'market-sketch-rain-table': curated('builtin_smiling_through_rain', 'smiling-through-rain.mp3', 'Smiling through rain', '2026-08-11T20:57:00.000Z'),
    'market-sketch-green-note': curated('builtin_green_note_score', 'late-night-focus.mp3', 'Green note study', '2026-08-11T21:02:00.000Z'),
    'market-aurora-stillwater': curated('builtin_impressionist_water', 'impressionist-water.mp3', 'Impressionist water', '2026-08-12T22:30:00.000Z'),
    'market-aurora-night-current': curated('builtin_luminous_current', 'luminous-current.mp3', 'Luminous current', '2026-08-11T21:40:00.000Z'),
    'market-japandi-blue-hour': curated('builtin_late_night_focus', 'late-night-focus.mp3', 'Late-night focus', '2026-08-11T21:02:00.000Z'),
    'market-japandi-warm-stillness': curated('builtin_warm_stillness_score', 'japanese-water-garden.mp3', 'Warm stillness', '2026-08-11T20:27:00.000Z'),
    'market-western-moon-ritual': curated('builtin_foggy_stone_shelter', 'foggy-stone-shelter.mp3', 'Foggy stone shelter', '2026-08-15T00:53:00.000Z'),
    'market-western-dust-signal': curated('builtin_dust_signal_score', 'last-broadcast.mp3', 'Dust signal transmission', '2026-08-13T22:18:47.735Z'),
    'market-deco-emerald-midnight': curated('builtin_emerald_midnight_score', 'late-night-focus.mp3', 'Emerald after-hours', '2026-08-11T21:02:00.000Z'),
    'market-deco-golden-hour': curated('builtin_golden_afterglow_score', 'electric-garden.mp3', 'Golden lounge pulse', '2026-08-11T20:51:00.000Z'),
    'market-synthwave-observatory': curated('builtin_night_observatory_score', 'luminous-current.mp3', 'Night observatory pulse', '2026-08-11T21:40:00.000Z'),
    'market-synthwave-coastal-drive': curated('builtin_coastal_drive_score', 'electric-garden.mp3', 'Coastal drive pulse', '2026-08-11T20:51:00.000Z'),
    'market-bauhaus-pavilion': curated('builtin_primary_pavilion_score', 'last-broadcast.mp3', 'Primary geometry', '2026-08-13T22:18:47.735Z'),
    'market-art-nouveau-conservatory': curated('builtin_moon_conservatory_score', 'japanese-water-garden.mp3', 'Moon conservatory', '2026-08-11T20:27:00.000Z'),
    'market-wabi-sabi-rain-bowl': curated('builtin_rain_bowl_score', 'smiling-through-rain.mp3', 'Rain bowl stillness', '2026-08-11T20:57:00.000Z'),
    'market-neo-brutalist-playground': curated('builtin_raw_playground_score', 'electric-garden.mp3', 'Raw playground rhythm', '2026-08-11T20:51:00.000Z'),
    'market-risograph-hill-ride': curated('builtin_hill_ride_score', 'electric-garden.mp3', 'Hill ride print rhythm', '2026-08-11T20:51:00.000Z'),
    'market-paper-cut-fox-valley': curated('builtin_fox_valley_score', 'pixel-forest.mp3', 'Fox valley nocturne', '2026-08-15T12:08:00.000Z'),
    'market-cyanotype-coast': curated('builtin_botanical_coast_score', 'impressionist-water.mp3', 'Botanical coast', '2026-08-12T22:30:00.000Z'),
    'market-stained-glass-heron': curated('builtin_heron_sunrise_score', 'luminous-current.mp3', 'Heron sunrise', '2026-08-11T21:40:00.000Z'),
    'market-surreal-collage-door': curated('builtin_ocean_door_score', 'foggy-stone-shelter.mp3', 'Ocean door dream', '2026-08-15T00:53:00.000Z'),
    'market-mid-century-lake-house': curated('builtin_lake_house_score', 'japanese-water-garden.mp3', 'Lake house morning', '2026-08-11T20:27:00.000Z'),
    'market-living-color-orbit': curated('builtin_electric_garden', 'electric-garden.mp3', 'Electric garden improvisation', '2026-08-11T20:51:00.000Z'),
    'market-living-midnight-haze': curated('builtin_koi_pond', 'koi-pond.mp3', 'Midnight koi pond', '2026-08-11T20:27:00.000Z'),
    'market-living-neon-koi': curated('builtin_bioluminescent_koi', 'bioluminescent-koi.mp3', 'Bioluminescent current', '2026-08-11T20:20:00.000Z'),
  };
