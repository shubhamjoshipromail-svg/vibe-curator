...
export const SYSTEM_PROMPT = [
  ...
  '- Explicit intent overrides that ambient default. If the user asks for bold,',
  '  psychedelic, kaleidoscopic, fractal, acid, trippy, or full-screen motion,',
  '  make the transformation clearly visible while still avoiding rapid flashes.',
